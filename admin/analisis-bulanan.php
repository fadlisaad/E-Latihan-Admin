...
<title>Analisis Kursus (Bulanan)</title>
...
<hr class="noscreen" />
    ...
    <hr class="noscreen" />
		...
		<div id="content" class="box">
		  <!-- Headings -->
          <h2>Analisis Kursus (Bulanan)</h2>
		  <hr />
		  <div class="buttons">
		  <a href="analisis-kursus-berjadual.php">
          <img src="img/icons/date_go.png" alt=""/>Kursus Berjadual</a>
		  </div>
		  <div class="buttons">
		  <a href="analisis-kursus-luar-jadual.php">
          <img src="img/icons/date_go.png" alt=""/>Kursus Luar Jadual</a>
		  </div>
		<div class="fix"></div>
		<br />
		<table width="100%">

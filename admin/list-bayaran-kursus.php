...
$query_kursus_senarai = "SELECT DISTINCT ts_kursus.* FROM ts_kursus, ts_peserta WHERE ts_peserta.ts_peserta_status=ts_kursus.ts_kursus_id";
$kursus_senarai = mysql_query($query_kursus_senarai, $ts_kursus) or die(mysql_error());
$row_kursus_senarai = mysql_fetch_assoc($kursus_senarai);
$totalRows_kursus_senarai = mysql_num_rows($kursus_senarai);

isset($startRow_kursus_senarai)? $orderNum=$startRow_kursus_senarai:$orderNum=0;
    ...
    <hr class="noscreen" />
		...
		<!-- InstanceBeginEditable name="content" -->
            <div id="content">
              ...
              <form action="" method="post" name="kursus_senarai" id="kursus_senarai">
                <p>Klik pada <strong>Tajuk</strong> untuk memaparkan penyata kewangan.</p>
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <thead>
          ...
          <th>Kategori</th>
          <th class="t-center">Tambah</th>
          <th class="t-center">Kemaskini</th>
          <th class="t-center">Cetak</th>
          </tr>
          </thead>
        <tbody>
          <?php do { ?>
            <tr valign="top">
              ...
              <td><?php echo $row_kursus_senarai['ts_kursus_kod']; ?></td>
              <td><a title="Klik untuk keterangan" href="laporan/penyata_pendapatan.php?ts_kursus_id=<?php echo $row_kursus_senarai['ts_kursus_id']; ?>"><?php echo strtoupper($row_kursus_senarai['ts_kursus_nama']); ?></a></td>
              <td class="a-left"><?php echo strtoupper($row_kursus_senarai['ts_kursus_kategori']); ?></td>
              <td class="t-center"><a href="laporan/penyata_pendapatan_add.php?ts_kursus_id=<?php echo $row_kursus_senarai['ts_kursus_id']; ?>"><img src="../images/icons/add.png" alt="Masuk data baru" /></a></td>
              <td class="t-center"><a href="laporan/penyata_pendapatan_edit.php?ts_kursus_id=<?php echo $row_kursus_senarai['ts_kursus_id']; ?>"><img src="../images/icons/add_page.png" alt="Kemaskini" /></a></td>
              <td class="t-center"><img src="../images/icons/full_page.png" onclick="MM_openBrWindow('laporan/penyata_pendapatan.php?ts_kursus_id=<?php echo $row_kursus_senarai['ts_kursus_id']; ?>','PenyataPendapatan','toolbar=yes,status=yes,scrollbars=yes,width=800,height=600')" alt="Cetak" /></td>
            </tr>
            <?php } while ($row_kursus_senarai = mysql_fetch_assoc($kursus_senarai)); ?>
          </tbody>
        </table>
              </form>
              <div id="pager">
                <?php include "includes/back.html"; ?>
                </div>
                  <br />
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($kursus_senarai);
?>
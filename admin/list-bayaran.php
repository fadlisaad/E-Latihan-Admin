 ...
 * 
 * Description : Bayaran honorarium.
 */
error_reporting(0);
              ...
              <table class="sortable" width="100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo strtoupper($row_bayaran['instruct_name']); ?></td>
                    <td><?php echo $row_bayaran['instruct_agency']; ?></td>
                    <td class="a-right">RM <?php echo $row_bayaran['jumlah']; ?></td>
                  </tr>
                  <?php } while ($row_bayaran = mysql_fetch_assoc($bayaran)); ?>
                  </tbody>
                <tfoot>
                  <tr>
                    <td colspan="3" class="a-center"><strong class="a-right">JUMLAH</strong></td>
                    <td class="a-right"><strong>RM <?php echo $sum; ?></strong></td>
                  </tr>
                </tfoot>
              </table>
                  <br />

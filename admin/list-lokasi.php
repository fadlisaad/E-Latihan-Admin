...
<hr class="noscreen" />
    ...
    <hr class="noscreen" />
		...
		<!-- InstanceBeginEditable name="content" -->
            ...
            <div class="buttons">
              <a href="tambah-lokasi.php">
              <img src="../admin/img/icons/add.png" alt=""/>Tambah Lokasi</a></div>
              <div class="buttons">
              <a href="javascript:history.go(-1)">
              <img src="../admin/img/icons/arrow_undo.png" alt=""/>Kembali</a></div>
              <p>&nbsp;</p>
              <table width="100%">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="details-lokasi.php?ts_tempat_ID=<?php echo $row_lokasi_senarai['ts_tempat_ID']; ?>"><?php echo $row_lokasi_senarai['ts_tempat_nama']; ?></a></td>
                    <td><?php echo $row_lokasi_senarai['ts_tempat_pengurus']; ?></td>
                    <td><?php echo $row_lokasi_senarai['ts_tempat_email']; ?></td>
                    <td><?php echo $row_lokasi_senarai['ts_tempat_telefon']; ?></td>
                    <td class="a-center"><a href="../upload/<?php echo $row_lokasi_senarai['ts_tempat_peta']; ?>">Papar</a></td>
                    <td><a href="edit-lokasi.php?ts_tempat_ID=<?php echo $row_lokasi_senarai['ts_tempat_ID']; ?>"><img src="img/icons/user_edit.png" width="16" height="16" border="0" title="Edit" /></a><a href="padam-lokasi.php?ts_tempat_ID=<?php echo $row_lokasi_senarai['ts_tempat_ID']; ?>"><img src="img/icons/user_delete.png" width="16" height="16" title="Delete" onclick="MM_popupMsg('Anda pasti?')" /></a></td>
                  </tr>

...
$query_senarai_vendor = "SELECT * FROM ts_vendor";
$senarai_vendor = mysql_query($query_senarai_vendor, $ts_kursus) or die(mysql_error());
$row_senarai_vendor = mysql_fetch_assoc($senarai_vendor);
$totalRows_senarai_vendor = mysql_num_rows($senarai_vendor);

isset($startRow_senarai_vendor)? $orderNum=$startRow_senarai_vendor:$orderNum=0;
    ...
    <hr class="noscreen" />
		...
		<!-- InstanceBeginEditable name="content" -->
            <div id="content">
              ...
              <h3>Senarai Penaja </h3>
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <th width="11%"><strong class="tcenter">Bil</strong></th>
                  <th width="22%" align="center"><strong>Nama Agensi/Penaja</strong></th>
                  <th width="49%" align="center"><strong>Pengurus</strong></th>
                  <th colspan="2" align="center"><strong>Tindakan</strong></th>
                </tr>
                <?php do { ?>
                <tr>
                  <td width="10%" class="a-center"><?php echo ++$orderNum; ?></td>
                  <td nowrap="nowrap"><a title="Klik untuk keterangan lanjut" href="details-penaja.php?kursus_vendor_ID=<?php echo $row_senarai_vendor['kursus_vendor_ID']; ?>"><?php echo $row_senarai_vendor['kursus_vendor_nama']; ?></a></td>
                  <td><?php echo $row_senarai_vendor['kursus_vendor_personel']; ?></td>
                  <td width="10%" align="center" valign="middle"><a href="ubah-penaja.php?kursus_vendor_ID=<?php echo $row_senarai_vendor['kursus_vendor_ID']; ?>" class="urg4">Ubah</a></td>
                  <td width="10%" align="center" valign="middle"><a href="padam-penaja.php?kursus_vendor_ID=<?php echo $row_senarai_vendor['kursus_vendor_ID']; ?>" class="urg3" onclick="MM_popupMsg('Anda pasti? ')">Padam</a></td>
                </tr>
                <?php } while ($row_senarai_vendor = mysql_fetch_assoc($senarai_vendor)); ?>
              </table>
              <div id="pager">
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($senarai_vendor);
?>
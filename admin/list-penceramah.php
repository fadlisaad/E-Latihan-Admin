 ...
 * 
 * Description : Payment for instructor.
 */
error_reporting(0);
...
$query_payment = "SELECT ts_instructor.* FROM ts_instructor";
$payment = mysql_query($query_payment, $ts_kursus) or die(mysql_error());
$row_payment = mysql_fetch_assoc($payment);
$totalRows_payment = mysql_num_rows($payment);

isset($startRow_payment)? $orderNum=$startRow_payment:$orderNum=0;
?>
...
<title>E-Latihan - Senarai Penceramah</title>
...
<hr class="noscreen" />
    ...
    <hr class="noscreen" />
		...
		<!-- InstanceBeginEditable name="content" -->
            <div id="content">
              <h3>Senarai Penceramah</h3>
			  <hr />
              <div class="fix"></div>
              <p class="msg info">Klik pada nama penceramah untuk keterangan lanjut</p>
              <table  class="sortable" width="100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
						<a href="details-penceramah.php?instruct_id=<?php echo $row_payment['instruct_id']; ?>"><?php echo strtoupper($row_payment['instruct_name']); ?></a>
					</td>
                  </tr>

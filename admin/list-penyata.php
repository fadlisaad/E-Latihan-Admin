...
<title>Penyata Perbelanjaan</title>
    ...
    <hr class="noscreen" />
      ...
      <table class="sortable" width="100%" border="0" cellpadding="0" cellspacing="0">
        <thead>
          ...
          <th nowrap="nowrap"><div align="center">Tajuk</div></th>
          <th><div align="center">Kategori</div></th>
          <th><div align="center">Tambah</div></th>
          <th><div align="center">Kemaskini</div></th>
          <td><div align="center">Cetak</div></td>
        </tr>
          </thead>
        <tbody>
          <?php do { ?>
            <tr valign="top">
              ...
              <td><div align="right" class="a-center"><a href="laporan/penyata_pendapatan_add.php?ts_kursus_id=<?php echo $row_kursus_senarai['ts_kursus_id']; ?>"><img src="../images/icons/add.png" alt="Masuk data baru" /></a></div></td>
              <td><div align="center"><a href="laporan/penyata_pendapatan_edit.php?ts_kursus_id=<?php echo $row_kursus_senarai['ts_kursus_id']; ?>"><img src="../images/icons/add_page.png" alt="Kemaskini" /></a></div></td>
              <td><img src="../images/icons/full_page.png" onclick="MM_openBrWindow('laporan/penyata_pendapatan.php?ts_kursus_id=<?php echo $row_kursus_senarai['ts_kursus_id']; ?>','PenyataPendapatan','toolbar=yes,status=yes,scrollbars=yes,width=800,height=600')" alt="Cetak" /></td>
            </tr>

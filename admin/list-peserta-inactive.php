 ...
 * 
 * Description : Senarai peserta Kursus yang tidak aktif.
 */
error_reporting(0);
...
$query_kursus = "SELECT ts_peserta.ts_peserta_nama, ts_peserta.ts_peserta_email, ts_peserta.ts_peserta_status, ts_peserta.ts_peserta_ID, ts_kursus.ts_kursus_nama FROM ts_peserta, ts_invoice, ts_kursus WHERE ts_peserta.ts_peserta_status=ts_invoice.kursus_id AND ts_peserta.ts_peserta_ID=ts_invoice.peserta_id AND ts_invoice.kursus_id=ts_kursus.ts_kursus_id AND ts_peserta.active=0";
...
<title>Peserta tidak aktif</title>
    ...
    <hr class="noscreen" />
		...
		<!-- InstanceBeginEditable name="content" -->
            <div id="content">
              ...
              <p class="msg info">Sila klik pada nama peserta untuk keterangan mengenai peserta berdaftar. Klik pada 'E-mail' untuk menghantar salinan pengesahan e-mail kepada peserta.</p>
              <table width="100%">
                <thead>
                  <tr>
                    <th width="15">Bil.</th>
				    <th class="t-left">Nama</th>
                    <th class="t-left">Kursus</th>
                    <th class="t-center">E-mail</th>
                  </tr>
                </thead>
                <tbody>
                  <?php 
						$a = $row_list['COUNT(ts_peserta_status)'];
                  ...
                  <tr>
                    ...
                    <td nowrap="nowrap" class="t-left"><a href="../user/user-page.php?ts_peserta_ID=<?php echo $row_kursus['ts_peserta_ID']; ?>"><?php echo strtoupper($row_kursus['ts_peserta_nama']); ?></a></td>
                    <td nowrap="nowrap" class="t-left"><?php echo $row_kursus['ts_kursus_nama']; ?></td>
                    <td nowrap="nowrap" class="t-center"><a href="includes/sendmail.php?ts_peserta_ID=<?php echo $row_kursus['ts_peserta_ID']; ?>"><img src="img/icons/email.png" alt="<?php echo $row_kursus['ts_peserta_email']; ?>" title="<?php echo $row_kursus['ts_peserta_email']; ?>"/></a></td>
                  </tr>

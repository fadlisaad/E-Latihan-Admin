 ...
 * 
 * Description : Senarai topik Kursus.
 */
error_reporting(0);
...
$query_list = "SELECT ts_topic.topic_instructor, ts_topic.topic_title, ts_topic.topic_date, ts_kursus.ts_kursus_id, ts_kursus.ts_kursus_nama FROM ts_topic, ts_kursus WHERE ts_kursus.ts_kursus_id=ts_topic.topic_status ORDER BY ts_topic.topic_date";
    ...
    <hr class="noscreen" />
		...
		<!-- InstanceBeginEditable name="content" -->
            <div id="content">
              ...
              <table width="100%">
                <thead>
                  <tr>
                    ...
                    <th>Tajuk Ceramah</th>
					<th>Tarikh</th>
                    <th width="70" nowrap="nowrap">Penceramah</th>
                  </tr>
                </thead>
                <tbody>
                  <?php do { ?>
                  <tr>
                    ...
                    <td><a href="list-peserta-kursus.php?ts_kursus_id=<?php echo $row_list['ts_kursus_id']; ?>"><?php echo $row_list['ts_kursus_nama']; ?></a></td>
                    <td><?php echo $row_list['topic_title']; ?></td>
					<td><?php echo $row_list['topic_date']; ?></td>
                    <td nowrap="nowrap"><?php echo $row_list['topic_instructor']; ?></td>
                  </tr>
              ...
              <table width="10%" class="nostyle">
                <tr>
                  <td width="30">Back</td>
                  <td width="8%"><a href="<?php printf("%s?pageNum_list=%d%s", $currentPage, max(0, $pageNum_list - 1), $queryString_list); ?>"><img src="../design/switcher-1col.gif" border="0" /></a> </td>
                  <td width="8%"><a href="<?php printf("%s?pageNum_list=%d%s", $currentPage, min($totalPages_list, $pageNum_list + 1), $queryString_list); ?>"><img src="../design/switcher-2col.gif" border="0" /></a> </td>
                  <td width="30">Next</td>
                </tr>
              </table>
              </p>

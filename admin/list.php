...
$query_list = "SELECT * FROM ts_admin ORDER BY ts_admin_ID ASC";
$list = mysql_query($query_list, $ts_kursus) or die(mysql_error());
$row_list = mysql_fetch_assoc($list);
$totalRows_list = mysql_num_rows($list);

mysql_select_db($database_ts_kursus, $ts_kursus);
$query_course = "SELECT ts_kursus.ts_kursus_kod, ts_kursus.ts_kursus_nama FROM ts_kursus";
$course = mysql_query($query_course, $ts_kursus) or die(mysql_error());
...
<hr class="noscreen" />
    ...
    <hr class="noscreen" />
		...
		<!-- InstanceBeginEditable name="content" -->
            <div id="content">
              <h3>Senarai Admin / Penyelaras</h3>
			  <hr />
              <div class="buttons">
              <a href="tambah-admin.php">
              <img src="img/icons/add.png" alt=""/>Tambah Admin</a></div>
              <p>
              <table width="100%">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="details-admin.php?ts_admin_ID=<?php echo $row_list['ts_admin_ID']; ?>"><?php echo $row_list['ts_admin_nama']; ?></a></td>
                    <td><?php echo $row_list['ts_admin_email']; ?></td>
                    <td align="center" valign="middle"><a href="ubah-admin.php?ts_admin_ID=<?php echo $row_list['ts_admin_ID']; ?>"><img src="img/icons/user_edit.png" title="Edit user" width="16" height="16" /></a><a href="padam-user.php?ts_admin_ID=<?php echo $row_list['ts_admin_ID']; ?>"><img src="img/icons/user_delete.png" width="16" height="16" border="0" title="Delete user" onclick="tmt_confirm('Are%20you%20sure%20you%20want%20to%20perform%20this%20action?');return document.MM_returnValue" /></a></td>
                  </tr>

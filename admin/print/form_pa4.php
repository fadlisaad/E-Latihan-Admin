...
<title>e-Opinion for KL City Plan 2020-Borang PA4</title>
...
<body>
<p align="right" class="style11"><strong>Borang PA 4</strong></p>
<hr />

<table width="100%" border="0">
  <tr>
    <td width="18%" class="style11"><div align="right"><img src="../images/Draf_DBKL.jpg" alt="draft" width="153" height="93" /></div></td>
    <td width="66%" class="style11"><p align="center"><strong>BORANG PENDENGARAN PANDANGAN AWAM <br />
SEMASA MESYUARAT JAWATANKUASA PENDENGARAN PANDANGAN AWAM <br />
DRAF PELAN BANDAR RAYA KUALA LUMPUR 2020</strong></p></td>
    <td width="16%" class="style11"><img src="../images/logo_PA4.jpg" alt="s" width="153" height="49" /></td>
  </tr>
</table>
...
<table width="37%" border="1" align="right">
  ...
  <tr>
    <td class="style11">Pegawai Key-in </td>
    <td class="style11"><em>
      <?php 
...
<table border="0" cellspacing="0" cellpadding="0" width="648">
  ...
  <tr>
    ...
    <td class="style11" border="0"><strong><em>
      ...
      <?php echo $row_public_form['passport']; ?></em></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="style11" border="0"><strong><em>
      ...
      &nbsp;<?php echo $row_public_form['city']; ?></em></strong></td>
  </tr>
  <tr>
    <td class="style11">&nbsp;</td>
    <td class="style11"></td>
...
<table border="0" cellspacing="0" cellpadding="0" align="left" width="100%">
  <tr>
    ...
    <td width="19" class="style11">:</td>
    <td width="453" class="style11"><strong><?php echo $row_public_form['theme']; ?></strong></td>
  </tr>
  <tr>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" class="style11"><strong>PENGESYORAN PANDANGAN (<em>Di Isi Oleh Ahli</em> <em>Mesyuarat JKPPA</em>)</strong></td>
  </tr>
</table>
<p class="style11"><strong>14. Pengesyoran Pandangan  Yang Didengar</strong><br />
...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="style11"><img src="box.jpg" width="21" height="20" /></td>
    <td class="style11">&nbsp;&nbsp;Diterima / Ditolak </td>
    <td width="350" class="style11"></td>
  </tr>
  <tr>
    <td class="style11">&nbsp;</td>
    <td class="style11">&nbsp;</td>
    <td width="350" class="style11">Justifikasi : </td>
  </tr>
  <tr>
    <td class="style11"></td>
    <td class="style11"></td>
    <td width="350" class="style11"><img src="form.jpg" width="610" height="284" />    </td>
  </tr>
</table>
<span class="style11"><br />
</span>
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="350" class="style11">Telah disemak oleh pengerusi panel</td>
  </tr>
</table>
<p class="style11">Disahkan :</p>
<div align="left"></div>
<table width="53%" border="0" align="left">
  ...
  <tr>
    <td class="style11"><div align="center">T/Tangan  Pengerusi</div></td>
  </tr>
</table>
<p class="style11">&nbsp;</p>
<p class="style11"><br />
* <em>perlu diisi oleh ahli JKPPA yang  bertugas</em></p>
<hr />
...
<table width="610" border="0">
  ...
  <tr>
    <td class="style11">Nama Pegawai yang kemas kini</td>

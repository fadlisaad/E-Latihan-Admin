...
?>
<img src="top_bm.jpg" width="93" height="65">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
No Pandangan: PTKL2020/DRAFT/<?php echo $row_public_form['id']; ?><br />
<br /><br /><br />
Kepada: 
<br /><br /><br />
<table width="90%" border="0">
  <tr>
    <td>&nbsp;</td>
    <td><?php echo $row_public_form['first_name']; ?> <?php echo $row_public_form['last_name']; ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;<?php echo $row_public_form['address1']; ?> <?php echo $row_public_form['address2']; ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;<?php echo $row_public_form['postal_code']; ?> <?php echo $row_public_form['city']; ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;<?php echo $row_public_form['state']; ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;<?php echo $row_public_form['country']; ?></td>
  </tr>
</table>
<br />
<br />
...
<br />Tarikh diterima: <?php echo $row_public_form['date']; ?><br /><br />

...
<hr class="noscreen" />
    ...
    <hr class="noscreen" />
		...
		<!-- InstanceBeginEditable name="content" -->
            <div id="content">
              <p>Paparan ini menunjukkan pelbagai laporan ringkas untuk sistem ini. Klik pada pautan untuk keterangan lanjut.</p>
	          <h3>Kursus Popular </h3>
	          <table width="100%">
		        <thead>
		          <tr>
		            <th>Tajuk</th>
		          ...
		          <?php do { ?>
		            <tr>
		              <td><?php echo chop($row_popular['ts_kursus_nama']); ?></td>
                        <td width="100" class="t-center"><?php echo $row_popular['COUNT(ts_peserta_status)']; ?></td>
                    </tr>
              ...
              <table width="100%">
                <thead>
                  <tr>
                    <th>Nama Penaja </th>
                          <th width="100">Bil. Kursus </th>
                  </tr>
                </thead>
                <tbody>
                  <?php do { ?>
                    <tr>
                      <td><?php echo $row_count_penaja['ts_kursus_vendor']; ?></td>
				          <td width="100" class="t-center"><?php echo $row_count_penaja['COUNT(kursus_vendor_nama)']; ?></td>
	              </tr>
                    <?php } while ($row_count_penaja = mysql_fetch_assoc($count_penaja)); ?>
                </tbody>
              </table>
              ...
              <h3>Kategori Kursus </h3>
	            <table width="100%">
                  ...
                  <tbody>
                    <?php do { ?>
                      <tr>
                        <td><a href="list-kursus-kategori.php?ts_kursus_kategori=<?php echo $row_count_kursus['ts_kursus_kategori']; ?>"><?php echo $row_count_kursus['ts_kursus_kategori']; ?></a></td>
                            <td width="100" class="t-center"><?php echo $row_count_kursus['COUNT(ts_kursus_id)']; ?></td>
                    </tr>
                      <?php } while ($row_count_kursus = mysql_fetch_assoc($count_kursus)); ?>
                  </tbody>
              </table>
              ...
              <h3>Senarai Admin </h3>
                <table width="100%">
                  ...
                  <tbody>
                    <?php do { ?>
                      <tr>
                        <td><a title="Klik untuk keterangan" href="details-admin.php?ts_admin_ID=<?php echo $row_report_admin['ts_admin_ID']; ?>"><?php echo $row_report_admin['ts_admin_nama']; ?></a></td>
                    </tr>
                      <?php } while ($row_report_admin = mysql_fetch_assoc($report_admin)); ?>
                  </tbody>
              </table>
                <div id="pager">

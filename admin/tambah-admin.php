...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO ts_admin (ts_admin_username, ts_admin_password, ts_admin_nama, ts_admin_phone, ts_admin_email, ts_admin_year) VALUES (%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['username'], "text"),
                       GetSQLValueString(md5($_POST['password']), "text"),
                       GetSQLValueString(strtoupper($_POST['fullname']), "text"),
                ...
                <fieldset>
				  ...
				  <table width="100%" class="nostyle">
                    <tr>
                      ...
                      <td><input name="fullname" type="text" class="input-text" id="fullname" tabindex="1" size="40" /></td>
                    </tr>
                    <tr>
                      <td width="150">Username</td>
                      <td><input name="username" type="text" class="input-text" id="username" tabindex="2" /></td>
                    </tr>
                    <tr>
                      <td width="150">Password</td>
                      <td><input name="password" type="text" class="input-text" id="password" tabindex="3" /></td>
                    </tr>
                    <tr>
                      <td width="150">E-mail</td>
                      <td><input name="email" type="text" class="input-text" id="email" tabindex="4" /></td>
                    </tr>
                    <tr>
                      <td width="150">Telefon</td>
                      <td><input name="phone" type="text" class="input-text" id="phone" tabindex="5" /></td>
                    </tr>
                  </table>
                </fieldset>
                <input type="hidden" name="MM_insert" value="form1">
                <input name="admin_year" type="hidden" id="admin_year" value="<?php echo date('Y'); ?>" />
                <div id="pager">

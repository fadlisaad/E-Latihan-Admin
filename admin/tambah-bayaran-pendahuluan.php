...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "rekod-advance")) {
  ...
  $insertGoTo = "list-bayaran-pendahuluan.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_ts_kursus, $ts_kursus);
$query_kursus = "SELECT ts_kursus.ts_kursus_id, ts_kursus.ts_kursus_nama FROM ts_kursus";
...
mysql_select_db($database_ts_kursus, $ts_kursus);
$query_rekod = "SELECT ts_kursus.ts_kursus_kod, ts_admin.ts_admin_nama, ts_advance.ts_advance_tarikh_ambil, ts_advance.ts_advance_tarikh_kembali, ts_advance.ts_advance_jumlah FROM ts_advance, ts_admin, ts_kursus WHERE ts_admin.ts_admin_ID=ts_advance.ts_advance_penyelaras_id AND ts_advance.ts_advance_kursus_id=ts_kursus.ts_kursus_id GROUP BY ts_advance.ts_advance_id";
			...
			<fieldset id="personal">
                <legend>Informasi</legend>
					<table width="100%" class="nostyle">
						...
						<tr>
							<td>Kursus</td>
							<td><select name="kursus" id="kursus" class="input-text">
							<?php do { ?><option value="<?php echo $row_kursus['ts_kursus_id']?>"><?php echo $row_kursus['ts_kursus_nama']?></option>

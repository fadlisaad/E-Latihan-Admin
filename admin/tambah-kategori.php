<?php require_once('../Connections/ts_kursus.php'); ?><?php
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO ts_kategori (ts_kategori_nama) VALUES (%s)",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO ts_report_kategori (report_kategori, report_kategori_sum) VALUES (%s, %s)",
                       GetSQLValueString($_POST['kursus_kategori'], "text"),
...
<hr class="noscreen" />
    ...
    <hr class="noscreen" />
        ...
        <h3>Tambah Kategori</h3>
          <form name="form1" id="form" method="post" action="<?php echo $editFormAction; ?>">
            <fieldset>
            <legend>Nama Kategori</legend>
	  <label for="kategori_name">Kategori : </label>
            <input name="kursus_kategori" type="text" class="input-text" id="kursus_kategori" tabindex="1" onfocus="MM_validateForm('kursus_kategori','','R');return document.MM_returnValue" size="40" />
            <br />
            <input type="hidden" name="MM_insert" value="form1" />
            <input name="ts_kategori_ID" type="hidden" id="ts_kategori_ID" value="<?php echo $row_add_kategori['ts_kategori_ID']; ?>" />
            </fieldset>
      <div id="pager"><?php include "includes/button.html"; ?></div>
      </form>

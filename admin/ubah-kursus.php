...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE ts_kursus SET ts_kursus_nama=%s, ts_kursus_kod=%s, ts_kursus_kategori=%s, ts_kursus_keterangan=%s, ts_kursus_lokasi=%s, ts_kursus_tarikh_mula=%s, ts_kursus_tarikh_tamat=%s, ts_kursus_harga=%s, ts_kursus_vendor=%s, ts_kursus_admin=%s, ts_kursus_bil_min=%s, ts_kursus_bil_max=%s, ts_kursus_year=%s, ts_kursus_publish_status=%s, ts_kursus_pubdate=%s, ts_kursus_jadual=%s WHERE ts_kursus_id=%s",
  ...
  $updateGoTo = "list-peserta-kursus.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['ts_kursus_id'])) {
  $colname_kursus_ubah = $_GET['ts_kursus_id'];
}
mysql_select_db($database_ts_kursus, $ts_kursus);
$query_kursus_ubah = sprintf("SELECT * FROM ts_kursus WHERE ts_kursus_id = %s", GetSQLValueString($colname_kursus_ubah, "int"));
			  ...
			  <fieldset>
                  ...
                  <table width="100%" class="nostyle">
					<tr>
						...
						<td><input name="year" type="text" class="input-text" id="year" value="<?php echo $row_kursus_ubah['ts_kursus_year']; ?>" size="5" /></td>
					</tr>
                    <tr>
                      <td width="15%">Tajuk kursus</td>
                      <td><input name="kursus_nama" type="text" class="input-text" id="kursus_nama" value="<?php echo $row_kursus_ubah['ts_kursus_nama']; ?>" size="80" /></td>
                    </tr>
                    <tr>
                      <td width="15%">Kod kursus</td>
                      <td><input name="kursus_kod" type="text" class="input-text" id="kursus_kod" value="<?php echo $row_kursus_ubah['ts_kursus_kod']; ?>" size="15" /></td>
                    </tr>
					<tr>
                      <td width="15%">Tahun</td>
                      <td><input name="year" type="text" class="input-text" id="year" value="<?php echo $row_kursus_ubah['ts_kursus_year']; ?>" size="10" /></td>
                    </tr>
                    <tr>
                      <td width="15%">Kluster</td>
                      <td><input <?php if (!(strcmp($row_kursus_ubah['ts_kursus_kategori'],"Teknologi Tanaman "))) {echo "checked=\"checked\"";} ?> type="radio" name="kursus_kategori" id="kursus_kategori" value="Teknologi Tanaman " />
                        Teknologi Tanaman
                          <br />
                      <input <?php if (!(strcmp($row_kursus_ubah['ts_kursus_kategori'],"Teknologi Ternakan"))) {echo "checked=\"checked\"";} ?> type="radio" name="kursus_kategori" id="kursus_kategori" value="Teknologi Ternakan" />
                        Teknologi Ternakan
                        <br />
                      <input <?php if (!(strcmp($row_kursus_ubah['ts_kursus_kategori'],"Teknologi Makanan"))) {echo "checked=\"checked\"";} ?> type="radio" name="kursus_kategori" id="kursus_kategori" value="Teknologi Makanan" />
                        Teknologi Makanan
                        <br />
                        <input <?php if (!(strcmp($row_kursus_ubah['ts_kursus_kategori'],"Teknologi Lanjutan"))) {echo "checked=\"checked\"";} ?> type="radio" name="kursus_kategori" id="kursus_kategori" value="Teknologi Lanjutan" />
                      Teknologi Lanjutan </td>
                    </tr>
                    <tr>
                      <td width="15%">Jenis Kursus</td>
                      <td><input <?php if (!(strcmp($row_kursus_ubah['ts_kursus_vendor'],"Kursus Berjadual"))) {echo "checked=\"checked\"";} ?> type="radio" name="penaja" id="penaja" value="Kursus Berjadual" />
                        Kursus Berjadual
                          <br />
                        <input <?php if (!(strcmp($row_kursus_ubah['ts_kursus_vendor'],"Kursus Luar Jadual"))) {echo "checked=\"checked\"";} ?> type="radio" name="penaja" id="penaja" value="Kursus Luar Jadual" />
                      Kursus Luar Jadual</td>
                    </tr>
                    <tr>
                      <td width="15%">Lokasi</td>
                      <td><select name="kursus_lokasi2" class="input-text" id="kursus_lokasi2">
                        <option value="tiada" <?php if (!(strcmp("tiada", $row_kursus_ubah['ts_tempat_nama']))) { echo "selected=\"selected\""; } ?>>- Sila Pilih -</option>
                        <?php do { ?>

                        <option value="<?php echo strtoupper($row_kursus_lokasi['ts_tempat_nama']); ?>"<?php if (!strcmp($row_kursus_ubah['ts_kursus_lokasi'], trim(strtoupper($row_kursus_lokasi['ts_tempat_nama'])))) { echo "selected=\"selected\""; } ?>><?php echo strtoupper($row_kursus_lokasi['ts_tempat_nama']); ?></option>
                        <?php } while ($row_kursus_lokasi = mysql_fetch_assoc($kursus_lokasi)); ?>
                      </select></td>
                    </tr>
                    <tr>
                      <td width="15%">Yuran (RM)</td>
                      <td><input name="kursus_harga" type="text" class="input-text" id="kursus_harga" value="<?php echo $row_kursus_ubah['ts_kursus_harga']; ?>" /></td>
                    </tr>
                  </table>
                </fieldset>
			    <fieldset>
			    ...
			    <table width="100%" class="nostyle">
                  <tr>
                    ...
                    <td><input name="tarikh_mula" type="text" class="input-text" id="tarikh_mula" size="15" value="<?php echo $row_kursus_ubah['ts_kursus_tarikh_mula']; ?>"/>
                  ...
                  <tr>
                    ...
                    <td><input name="tarikh_tamat" type="text" class="input-text" id="tarikh_tamat" size="15" value="<?php echo $row_kursus_ubah['ts_kursus_tarikh_tamat']; ?>"/>
				    <script type="text/javascript">
					  // <![CDATA[       
                  ...
                  <tr>
                    ...
                    <td><input name="tarikh_tutup" type="text" class="input-text" id="tarikh_tutup" size="15" value="<?php echo $row_kursus_ubah['ts_kursus_jadual']; ?>"/>
				    <script type="text/javascript">
					  // <![CDATA[       
                  ...
                  <tr>
                    ...
                    <td><input name="tarikh_papar" type="text" class="input-text" id="tarikh_papar" size="15" value="<?php echo $row_kursus_ubah['ts_kursus_pubdate']; ?>"/>
				    <script type="text/javascript">
					  // <![CDATA[       
			    ...
			    <table width="100%" class="nostyle">
                  <tr>
                    ...
                    <td><input name="kursus_max" type="text" class="input-text" id="kursus_max" value="<?php echo $row_kursus_ubah['ts_kursus_bil_max']; ?>" size="5" />
orang</td>
                  </tr>
                  <tr>
                    <td width="15%">Minimum</td>
                    <td><input name="kursus_min" type="text" class="input-text" id="kursus_min" value="<?php echo $row_kursus_ubah['ts_kursus_bil_min']; ?>" size="5" />
orang</td>
                  </tr>
                </table>
			    </fieldset>
			    ...
			    <table width="100%" class="nostyle">
                  <tr>
                    ...
                    <td><textarea name="keterangan" cols="30" rows="7" id="keterangan" class="wysiwyg"><?php echo $row_kursus_ubah['ts_kursus_keterangan']; ?></textarea> <p class="msg error">Nota: Jangan 'Copy and paste' dari Microsoft Word. Sila copy ke 'Notepad' dan kemudian 'paste' disini. Ubah keterangan dengan menggunakan format (bold, bullet, numbering) yang disediakan</p></td>
                  </tr>
                  <tr>
                    <td>Papar?</td>
                    <td><input <?php if (!(strcmp($row_kursus_ubah['ts_kursus_publish_status'],1))) {echo "checked=\"checked\"";} ?> name="published" type="checkbox" id="published" value="1" />
Tinggalkan ruangan ini jika tidak mahu paparan kursus serta merta </td>
			    ...
			    <input name="kursus_id" type="hidden" id="kursus_id" value="<?php echo $row_kursus_ubah['ts_kursus_id']; ?>" />
			    </fieldset>
				  <div id="pager">

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "ubah_admin")) {
  $updateSQL = sprintf("UPDATE ts_admin SET ts_admin_password=%s, ts_admin_nama=%s, ts_admin_phone=%s, ts_admin_email=%s, ts_admin_gambar=%s, ts_admin_year=%s WHERE ts_admin_username=%s",
                ...
                <fieldset id="personal">
                  ...
                  <table width="100%" class="nostyle">
                    ...
                    <tr>
                      ...
                      <td><input name="password2" type="password" id="password2" tabindex="3" /></td>
                    </tr>
                    <tr>
                      <td width="100">Masukkan semula</td>
                      <td><input name="password3" type="password" id="password3" tabindex="3" /></td>
                    </tr>
                  </table>

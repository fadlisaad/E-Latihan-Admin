...
if (isset($_GET['ts_kursus_id'])) {
  $colname_upload = $_GET['ts_kursus_id'];
}
mysql_select_db($database_ts_kursus, $ts_kursus);
$query_upload = sprintf("SELECT ts_kursus_id,ts_files.* FROM ts_kursus, ts_files WHERE ts_kursus.ts_kursus_id = %s AND ts_files.files_id = %s", GetSQLValueString($colname_upload, "int"),GetSQLValueString($colname_upload, "int"));
...
isset($startRow_upload)? $orderNum=$startRow_upload:$orderNum=0;
?> 
...
<title>e-Latihan - Muat Naik</title>
    ...
    <hr class="noscreen" />
		...
		<!-- InstanceBeginEditable name="content" -->
            <div id="content">
              ...
              <h3>Senarai Fail untuk kursus</h3>
              <table width="100%">
			  <?php if ($totalRows_upload == 0) {
					echo "<p>Tiada brosur</p>";
					}
					else { ?>
                <thead>
                  <tr>
                    <th width="40" class="t-center">Bil</th>
                    <th>Nama Fail</th>
                    <th width="70" class="t-center">Saiz</th>
                    <th width="60" class="t-center">Action</th>
                  </tr>
                </thead>
                <tbody>
				<?php do { ?>
                    <tr>
                      ...
                      <td><a href="../upload.php?id=<?php echo $row_upload['id']; ?>"><?php echo trim($row_upload['name'],3); ?></a></td>
                      <td><?php echo ($row_upload['size']/1000); ?> kb</td>
                      <td class="t-center"><a href="padam-upload.php?id=<?php echo $row_upload['id']; ?>&ts_kursus_id=<?php echo $row_upload['ts_kursus_id']; ?>" onClick="javascript: return confirm('Are you SURE you wish to do this? \nClick OK to delete this file. \nClick CANCEL to return to previous page.');"><img src="img/icons/delete.png" width="16" height="16" title="Padam fail" /></a></td>
                    </tr>
                    <?php } while ($row_upload = mysql_fetch_assoc($upload)); ?>
                </tbody>
				<?php } ?>
              </table>
              <p class="msg info">Saiz maksimum fail diterima adalah 2 megabait (MB) sahaja. Jika fail yang dimuat-naik lebih besar dari fail diterima, muat-naik akan gagal.</p>
              <div class="buttons" onclick="MM_openBrWindow('upload.php?id=<?php echo $_GET['ts_kursus_id']; ?>','Upload','width=300,height=200')">
              <a href="#">
              <img src="img/icons/disk.png" alt=""/>Muat naik fail</a></div>
              <div class="buttons">
              <a href="list-peserta-kursus.php?ts_kursus_id=<?php echo $_GET['ts_kursus_id']; ?>">

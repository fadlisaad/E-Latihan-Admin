...
$query_jan = "SELECT COUNT(ts_kursus_id) AS jan FROM ts_kursus WHERE ts_kursus_tarikh_mula BETWEEN '".$start_date1."' AND '".$end_date1."'";
...
$query_feb = "SELECT COUNT(ts_kursus_id) AS feb FROM ts_kursus WHERE ts_kursus_tarikh_mula BETWEEN '".$start_date2."' AND '".$end_date2."'";
...
$query_mac = "SELECT COUNT(ts_kursus_id) AS mac FROM ts_kursus WHERE ts_kursus_tarikh_mula BETWEEN '".$start_date3."' AND '".$end_date3."'";
...
$query_apr = "SELECT COUNT(ts_kursus_id) AS apr FROM ts_kursus WHERE ts_kursus_tarikh_mula BETWEEN '".$start_date4."' AND '".$end_date4."'";
...
$query_mei = "SELECT COUNT(ts_kursus_id) AS mei FROM ts_kursus WHERE ts_kursus_tarikh_mula BETWEEN '".$start_date5."' AND '".$end_date5."'";
...
$query_jun = "SELECT COUNT(ts_kursus_id) AS jun FROM ts_kursus WHERE ts_kursus_tarikh_mula BETWEEN '".$start_date6."' AND '".$end_date6."'";
...
$query_jul = "SELECT COUNT(ts_kursus_id) AS jul FROM ts_kursus WHERE ts_kursus_tarikh_mula BETWEEN '".$start_date7."' AND '".$end_date7."'";
...
$query_ogo = "SELECT COUNT(ts_kursus_id) AS ogo FROM ts_kursus WHERE ts_kursus_tarikh_mula BETWEEN '".$start_date8."' AND '".$end_date8."'";
...
$query_sep = "SELECT COUNT(ts_kursus_id) AS sep FROM ts_kursus WHERE ts_kursus_tarikh_mula BETWEEN '".$start_date9."' AND '".$end_date9."'";
...
$query_okt = "SELECT COUNT(ts_kursus_id) AS okt FROM ts_kursus WHERE ts_kursus_tarikh_mula BETWEEN '".$start_date10."' AND '".$end_date10."'";
...
$query_nov = "SELECT COUNT(ts_kursus_id) AS nov FROM ts_kursus WHERE ts_kursus_tarikh_mula BETWEEN '".$start_date11."' AND '".$end_date11."'";
...
$query_dis = "SELECT COUNT(ts_kursus_id) AS dis FROM ts_kursus WHERE ts_kursus_tarikh_mula BETWEEN '".$start_date12."' AND '".$end_date12."'";

...
$query_change = sprintf("SELECT ts_admin_ID, ts_admin_password FROM ts_admin WHERE ts_admin_password = %s AND ts_admin_ID = %s", GetSQLValueString($colname_change, "text"),GetSQLValueString($colname2_change, "int"));
...
<p class="bottom">Hakcipta terpelihara &copy; 2010 E-Latihan MARDI<?php echo $row_change['ts_admin_ID']; ?></p>
</div>
</body></html>
<?php

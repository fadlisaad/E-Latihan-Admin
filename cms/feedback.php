...
$query_cms_content = "SELECT * FROM ts_cms WHERE ts_cms.cms_id=16";
...
<DIV id="columnright"><BR>
  ...
  <div id="content">
    ...
    <h1 class="featurenote">Tarikh kemaskini:<?php echo $row_cms_content['cms_lastupdate']; ?></h1>
    <h1><?php echo $row_cms_content['cms_content']; ?></h1>
    <form id="form" action="feedback_success.php" method="post">
      <fieldset id="personal">
      <legend>Maklumat Peribadi</legend>
      <label for="lastname">Nama Penuh : </label>
      <input name="lastname" type="text" id="lastname" tabindex="1" size="50" />
      <br />
      <label for="email">E-mail : </label>
      <input name="email" id="email" type="text" tabindex="2" />
      <br />
      <label for="tel">Telefon : </label>
      <input name="tel" id="tel" type="text" tabindex="3" />
      </fieldset>
      <fieldset id="address">
      <legend>Komen / Pendapat / Cadangan</legend>
      <label for="messege">Mesej : </label>
      <textarea name="messege" id="messege" cols="50" rows="5" tabindex="4" /></textarea>
      </fieldset>
      <fieldset id="opt">
      <legend>Pilihan</legend>
        <label for="choice">Tentang : </label>
      <select name="choice">
        <option selected="selected" label="general" value="general"> Umum </option>
        <option selected="selected" label="enquiry" value="enquiry"> Pertanyaan </option>
        <option selected="selected" label="others" value="others"> Pertanyaan </option>
        <optgroup label="Kemudahan Kursus">
        <option label="cg1a" value="Lokasi">Lokasi </option>
        <option label="cg1b" value="Makanan">Makanan </option>
        <option label="cg1c" value="Penginapan">Penginapan </option>
        </optgroup>
        <optgroup label="Kandungan Kursus">
        <option label="cg2a" value="Penceramah">Penceramah </option>
        <option label="cg2b" value="Topik">Topik </option>
        </optgroup>
        </select>
        <br /><br />
        <input name="email_copy" id="yes" type="checkbox" value="yes" tabindex="35" />Hantar satu salinan kepada e-mail saya 
      </fieldset>
      <div>
        <input id="button1" type="submit" value="Hantar" />
      </div>
    </form>   
  </div>
  <!-- InstanceEndEditable -->

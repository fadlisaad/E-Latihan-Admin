...
<p>Berikut adalah senarai kursus yang telah disediakan bagi sepanjang tahun 2010. Anda boleh mendaftar secara dalam talian sekarang. Klik pada Brosur untuk maklumat kursus, klik pada Mohon untuk memohon.</p>
    ...
    <thead class="sectiontableheader">
      ...
      <?php do { ?>
        <tr valign="top">
          ...
          <td width="60"><?php echo date("d/m/Y",strtotime($row_pertanian['ts_kursus_tarikh_mula'])); ?></td>
  ...
  <tbody>
    <?php do { ?>
      <tr valign="top">
        ...
        <td width="60"><?php echo date("d/m/Y",strtotime($row_penternakan['ts_kursus_tarikh_mula'])); ?></td>
    ...
    <tbody>
      <?php do { ?>
        <tr valign="top">
          ...
          <td width="60"><?php echo date("d/m/Y",strtotime($row_teknologi_makanan['ts_kursus_tarikh_mula'])); ?></td>
...
<p><table width="100%" class="weblinks">
      ...
      <tbody>
        ...
        <tr valign="top">
          ...
          <td width="60"><?php echo date("d/m/Y",strtotime($row_proses['ts_kursus_tarikh_mula'])); ?></td>

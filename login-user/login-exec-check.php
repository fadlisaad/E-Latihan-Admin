<!-- #BeginDate format:fcEn2a -->Tuesday, 05-Jan-2010 9:15 PM<!-- #EndDate -->
<?php
	/**
	...
	if($result) {
		if(mysql_num_rows($result) == 1) {
			...
			session_write_close();
			header("location:user-daftar.php?ts_peserta_ic=".$_SESSION['SESS_USERNAME']."&ts_kursus_id=".$_GET['ts_kursus_id']."");
			exit();
		}else {
			//Login failed

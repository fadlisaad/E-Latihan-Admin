...
<label class="big_i" for="username">No Kad Pengenalan:</label>
    ...
    <div style="float: right; width: 180px; padding-top: 20px; font-size: 11px; text-align: right;"><a href="../reset-user.php">Lupa kata laluan?</a><br>
    </div>

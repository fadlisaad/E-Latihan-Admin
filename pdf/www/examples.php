...
foreach ( $test_files as $file ) {
  ...
  echo $file;
  echo " [<a class=\"button\" target=\"blank\" href=\"test/$file\">HTML</a>] [<a class=\"button\" href=\"$dompdf&orientation=landscape&paper=a4&input_file=" . rawurlencode("www/test/$file") .  "&ts_kursus_id=11\">PDF</a>]\n";
  echo "</li>\n";
}
?>
</ul>
<?php echo"[<a class=\"button\" href=\"$dompdf&orientation=landscape&paper=a4&input_file=arahan-pengeluaran-kursus.php&ts_kursus_id=11\">PDF</a>]"; ?>
<a name="demo"> </a>
<h2>Demo</h2>

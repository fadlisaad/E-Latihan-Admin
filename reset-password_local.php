...
$link = mysql_connect('localhost', 'root', 'nazira'); 
if (!$link) {
...
$query="SELECT ts_admin_username, ts_admin_password, ts_admin_email FROM ts_admin WHERE ts_admin_email = '$email'";

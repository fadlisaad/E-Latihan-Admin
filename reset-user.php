 ...
 * 
 * Description : main script for reset lost password for user
 */
...
<h3>Reset kata laluan anda</h3>
    <form action="reset-password-user.php" method="POST">
    <label class="big_i" for="e-mail">E-mail:</label>
    <input name="e-mail" type="text" class="big_i" id="e-mail" value="">
    <div style="float: right; width: 120px; padding-top: 20px; font-size: 11px; text-align: right;"><a href="login-user/login.php">Kembali ke login</a></div>

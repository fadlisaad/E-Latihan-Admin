...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  ...
  $deleteGoTo = "user-page.php?ts_peserta_ID=" . $row_padam['ts_peserta_ID'] . "";
...
mysql_select_db($database_ts_kursus, $ts_kursus);
$query_padam = sprintf("SELECT id, ts_peserta.ts_peserta_ID FROM ts_files, ts_peserta WHERE id = %s AND ts_peserta.ts_peserta_ID=%s", GetSQLValueString($colname_padam, "int"),GetSQLValueString($colname2_padam, "int"));
